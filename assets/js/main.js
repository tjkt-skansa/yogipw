...
document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch("portfolio.json")
    ...
    .then(data => {
      data.forEach(item => {
        const html = `
          <div class="col-lg-6 col-md-6 portfolio-item isotope-item ${item.filter}">
            <div class="portfolio-wrap">
              <a href="${item.linkImage}" class="glightbox" title="${item.title}">
              ...
              <div class="portfolio-info">
                <div class="content">
                  ...
                  <div class="portfolio-links">
                    ...
                    <a href="${item.linkDetails}" title="More Details">
      ...
      // ✅ Isotope setup dengan filter default = July
      setTimeout(() => {
        if (typeof Isotope !== "undefined") {
          ...
          // Atur filter awal ke .filter-jul
          iso.arrange({ filter: '.filter-jul' });
